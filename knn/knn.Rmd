...
```{r}
test_pred <- knn(train = datos1.correlation[,-ncol(datos)], test = datos1.correlation[,-ncol(datos)],cl = datos1.correlation$C, k=3)
accuracy <- length(which(test_pred == datos1.correlation$C))/nrow(datos1.correlation)
accuracy
```
