...
Voy a dejar solo las variables X3,X12,,X16,X23,X27,X34,X41,X42

```{r}
datos <- datos[,c("X3","X12","X16","X23","X27","X34","X41","X42","C")]
test <- test[,c("X3","X12","X16","X23","X27","X34","X41","X42")]
```
...
```{r}
generarEnvio(y=test_pred,file="envio_tomek_links.csv")
```
