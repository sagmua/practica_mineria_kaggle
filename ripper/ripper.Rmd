...
highlyCorrelated = caret :: findCorrelation(cor(datos) , cutoff =0.99)
...
modelRipp <- JRip(formula = C~.,data = datos_duplicados)
...
generarEnvio(prediction, file = "datos_tomek_duplicados.csv")
