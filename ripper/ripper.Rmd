...
imputados.amelia <- Amelia::amelia(datos,m=2,parallel="multicore",noms="C")
...
```{r}
datos [,-51] = scale(datos[,-51], center = TRUE, scale = TRUE)
modelRipp <- JRip(C~.,data = datos)
...
generarEnvio(prediction, file = "seleccion2.csv")
