...
pred <- predict(svm_model_after_tune,svm_model_after_tune)
system.time(predict(svm_model_after_tune,svm_model_after_tune))
...
generarEnvio(prediccion, file = "EnvioSVM17.csv")
